...
class LearningAgent(Agent):
    ...
    def Q_analysis(self):
        """ Prints out statistics on the Q"""
        states = 0
        state_actions = 0
        for state in self.Q:
            #print "State:", state
            ...
            for action in Qs:
                ...
                if Qs[action] != 0.0:
                    state_actions += 1
        print "States:", states, ", State_actions:", state_actions
        max_states = 3*2*4*4*4.0
        max_state_actions = max_states * 4.0
        print "States %:", states/max_states, ", State_actions %:", state_actions/max_state_actions
